...
* [cursorWidth]({% link _docs/api/terminal/interfaces/iterminaloptions.md %}#cursorwidth)
...
* [windowOptions]({% link _docs/api/terminal/interfaces/iterminaloptions.md %}#windowoptions)
